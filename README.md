...
Descarga y ejecuta los archivos: [implementación 01](/Guia-de-Kubernetes-en-CBL-Mariner_automatic_01.sh) (Guía de Kubernetes en CBL Mariner) con permisos de administrador. Después de reiniciar el sistema, continúa con la [implementación 02](/Guia-de-Kubernetes-en-CBL-Mariner_automatic_02.sh) utilizando permisos de usuario.
