...
Descarga y ejecuta los archivos de [implementación 01](/Guia-de-Kubernetes-en-CBL-Mariner_automatic_01.sh) con privilegios de administrador y luego [implementación 02](/Guia-de-Kubernetes-en-CBL-Mariner_automatic_02.sh) con privilegios de usuario.
